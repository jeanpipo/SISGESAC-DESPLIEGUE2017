<?php
	$pdf = new FPDF('p','mm','A4');
		...
		$pdf->Cell(0,10,"LISTA DE ESTUDIANTES QUE YA SE ENCUENTRAN REGISTRADOS ",0,1,'C',true);
		$pdf->Cell(0,10,"POR LO QUE DEBEN SER REGISTRADOS MANUALMENTE",0,1,'C',true);
		$pdf->Cell(0,10,"EN EL MÓDULO DE ESTUDIANTES",0,1,'C',true);
		$pdf->Ln();

		$pdf->SetFont('Arial','B',11);
		$pdf->Cell(20,7,"Cédula",1,0,'C',true);
		$pdf->SetFillColor(255,255,255);
		$pdf->SetTextColor(0);
		$pdf->SetFont('Arial','B',11);
